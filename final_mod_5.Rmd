...
In 2019, Armenians around me were laughing at the fact that their country was marked as the angriest in the world in a Gallup survey with %45 of their population expressing feeling a lot of anger in the previous day[(McCarthy)](https://www.statista.com/chart/17842/share-of-the-population-that-experienced-a-lot-of-anger-yesterday/). This got me thinking about the well-being and the happiness of the population since I imagine that a psychologically distressed population would have a hard time developing its economy.
...
We see that GDP has been increasing at a very high rate that is over 10% until 2009 when it suffered a strong decrease in GDP, however was able to recover and have a high 7.5% increase in GDP in 2018 and even higher in 2019
...
![dilijan](dilijan.jpg)
This is Dilijan, the city I lived in.[Image source](https://www.itinari.com/dilijan-city-in-a-forest-lxxn)
...
animate(arrivals, duration = 12 , fps = 15, end_pause = 10)
```
...
This increase in number of tourists lead to a huge increase in revenues in the tourism sphere in the past years and generated a great number of business opportunities. Armenia is now generating over 1.5 Billion US dollars in revenue compared to a 560 million dollars generated in 2008 as indicated by the following interactive plot: 
...
# Remove eva; = False from animation
